...
public class ShopDecorationStyleAdapter extends BaseQuickAdapter<DeStyle,BaseViewHolder> {
    public ShopDecorationStyleAdapter() {
        super(R.layout.item_custom_furniture, null);
    }

    @Override
    protected void convert(BaseViewHolder helper, DeStyle item) {
