...
public class DeviceIDFactory {
    ...
    public static DeviceIDFactory getInstance() {
        return DeviceIDFactory.InstanceHolder.instance;
    }
    static class InstanceHolder {
        final static DeviceIDFactory instance = new DeviceIDFactory();
    }
    /**
    ...
    public String getIMEI() {
        TelephonyManager TelephonyMgr = (TelephonyManager) KnmsShopApp.getInstance().getSystemService(TELEPHONY_SERVICE);
    ...
    public String getAndroidID() {
        String m_szAndroidID = Settings.Secure.getString(KnmsShopApp.getInstance().getContentResolver(),
    ...
    public String getWLANMACAddress() {
        WifiManager wm = (WifiManager) KnmsShopApp.getInstance().getSystemService(Context.WIFI_SERVICE);
