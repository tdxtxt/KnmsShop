...
public class Star extends View {
    ...
    private void init(Context mContext, AttributeSet attrs){
        ...
        starMark = typedArray.getFloat(R.styleable.star_startMark,5.0f);
...
//        starMark = Math.round(mark * 10) * 1.0f / 10;//四舍五入
        starMark = mark.intValue() + 1;
